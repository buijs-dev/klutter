        ...
        "It should write a valid Dart file" {
            ...
            actual.readText().filter { !it.isWhitespace() } shouldBe """
                    ...
                    class Shazaam {
                     ...
                     factory Shazaam.fromJson(dynamic message) {
                       final json = jsonDecode(message);
                       return Shazaam (
                         age: json['age'].toInt(),
                         friends: json['friends']?.toInt(),
                         bff: json['bff']?.toString(),
                         powers: List<Power>.from(json.decode(json['powers']).map((o) => _Power.fromJson(o))),
                       );
                     }
                ...
                class Shazaam {
                 ...
                 factory Shazaam.fromJson(dynamic message) {
                   ...
                   return Shazaam (
                     ...
                     cDouble: List<double>.from(json.decode(json['cDouble'])?.map((o) => o.toDouble())),
                     dBoolean: List<bool>.from(json.decode(json['dBoolean']).map((o) => o.toLowerCase() == 'true')),
                   );
                 }
