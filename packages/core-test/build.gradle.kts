...
publishing {
    ...
    val libversion = (properties["core.test.version"] ?: "0.12.0")
        .also { println("VERSION CORE TEST ==> $it") }
    ...
    publications {
        create<MavenPublication>("maven") {
            ...
            version = libversion
            artifact("$projectDir/build/libs/core-test.jar")

            pom {
                name.set("Klutter: Core Test")
                description.set("Klutter Framework testing module")
