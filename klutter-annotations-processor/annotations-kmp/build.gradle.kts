...
kotlin {
    ...
    cocoapods {
        summary = "Klutter module for processing annotations"
        homepage = "https://buijs.dev"
        ios.deploymentTarget = "13"
        framework {
            baseName = "Annotations Processor"
        }
    }
...
//            url = uri("https://repsy.io/mvn/buijs-dev/klutter")
    ...
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                name.set("Klutter: Annotations Processor - KMP")
                description.set("Klutter Framework annotations processor used in Kotlin Multiplatform components")
