...
@Inject constructor(
    ...
    fun generateAdapter() {
        ...
        val flutter = ext.flutter?: throw KlutterCodeGenerationException("Flutter directory must be set")
        if(!flutter.exists()) throw KlutterCodeGenerationException("Flutter directory does not exist: ${flutter.absolutePath}")
